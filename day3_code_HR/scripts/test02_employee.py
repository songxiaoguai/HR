...
from day3_code_HR import api, log_file
from day3_code_HR.api.aoi_employee import ApiEmployee
from day3_code_HR.tools.assert_common import assert_common
from day3_code_HR.tools.path import path_hr
